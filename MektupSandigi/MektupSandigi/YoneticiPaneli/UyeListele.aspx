...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tabloTasiyici">
        <div>
            <asp:GridView ID="gv_Uyeler" runat="server" CssClass="gv-style" AutoGenerateColumns="False" OnRowCommand="gv_Uyeler_RowCommand1">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="İşlemler">
                        <ItemTemplate>
                            <asp:LinkButton ID="btnSil" runat="server" CommandName="Sil" 
                                CommandArgument='<%# Eval("KullaniciID") %>' Text="Sil" />
                            <asp:LinkButton ID="btnDurum" runat="server" CommandName="Durum" 
                                CommandArgument='<%# Eval("KullaniciID") %>' Text="Değiştir" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
