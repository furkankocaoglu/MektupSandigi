...
namespace MektupSandigi
{
    public partial class MektupYaz : System.Web.UI.Page
    {
        ...
        {
            tb_acilisTarihi.Text = calendarAcilisTarihi.SelectedDate.ToString("yyyy-MM-dd");
            calendarAcilisTarihi.Visible = false;
        }

        protected void btnAcilisTarihSec_Click(object sender, EventArgs e)
        {
            calendarAcilisTarihi.Visible = !calendarAcilisTarihi.Visible;
